<template>
  <div class="About">
    ...
    <StaticCard>
      {{
        $t(
          '当サイトは新型コロナウイルス感染症 (COVID-19) に関する最新情報を提供するために、Code for Shiogamaが開設したものです。'
        )
      }}<br />
      <br />
      {{
        $t(
          'ミヒャギ県による公式情報と客観的な数値をわかりやすく伝えることで、美雨や技研にお住まいの方や、宮城県内に拠点を持つ企業の方、宮城県を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
    </StaticCard>
    <StaticCard>
    ...
    <StaticCard>
      ...
      <p>
        {{
          $t(
            '当サイトに掲載されている情報の正確性については万全を期していますが、Code for Shiogamaは利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。'
          )
        }}
      </p>
      <p>
    ...
    <StaticCard>
      <h3>{{ $t('Code for Shiogamaについて') }}</h3>
      <p>
        {{
          $t(
            '宮城県塩竈市で活動する「地域の課題をITで解決する」をテーマとした団体です。'
          )
        }}
        <i18n path="詳しくは、{githubRepo}をご確認ください。">
          <a
